Since this project uses Chisaku's EasyBot.py framework, all licensing and contributing.md also applies here. And ofc the code of conduct also appiles as well. 
