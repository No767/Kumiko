...
class Auth(discord.ui.Button):
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        await interaction.response.send_message("Confirmed. Now you have access to the marketplace", ephemeral=True)
        self.value = True
        self.stop()
...
class ecoMarketplace(commands.Cog):
    ...
    @slash_command(name="eco-init", description="Initialize your user account", guild_ids=[866199405090308116])
